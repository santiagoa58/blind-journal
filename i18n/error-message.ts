...
export function useErrorMessage() {
  ...
  const formatters = useMemo(
    () =>
      ({
        [API_ERROR_CODES.networkUnavailable]: (values) =>
          t("api.errors.networkUnavailable", values),
        ...
        [AUTH_ERROR_CODES.invalidCredentials]: (values) =>
          t("auth.errors.invalidCredentials", values),
        ...
        [JOURNAL_CLIENT_ERROR_CODES.invalidContent]: (values) =>
          t("journal.errors.invalidEntry", values),
        ...
        [REQUEST_ERROR_CODES.payloadTooLarge]: (values) =>
          t("request.errors.payloadTooLarge", values),
