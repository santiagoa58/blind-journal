...
export const handlers = [
  ...
  http.post(`${API_BASE_URL}/entries`, ({ request }) =>
    handleCreateJournalEntryRequest(request),
  ),
  ...
  http.post(`${API_BASE_URL}/auth/login/salt`, ({ request }) =>
    handleLoginSaltRequest(request),
  ),
  http.post(`${API_BASE_URL}/auth/accounts`, ({ request }) =>
