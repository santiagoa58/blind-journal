...
describe("journal rich-text schema", () => {
  it("allows only the nodes, marks, and heading levels exposed by the editor", () => {
    const editor = createEditor(
      "<h1>Primary heading</h1><h2>Section</h2><h3>Allowed heading</h3><h4>Unsupported heading</h4>",
    );
    ...
    expect(editor.getHTML()).toBe(
      "<h1>Primary heading</h1><h2>Section</h2><h3>Allowed heading</h3><p>Unsupported heading</p>",
    );
  });
